...
// Include this where you need to display the recipient table
global $wpdb;
...
<div class="wrap">
    ...
    <form id="recipients-table" method="GET">
        <input type="hidden" name="page" value="<?php echo esc_attr($_REQUEST['page']); ?>" />
        <?php $table->search_box('Search Recipients', 'search_id'); ?>
        <?php $table->display(); ?>
    </form>
</div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $(document).ajaxStart(function() {
            $('#recipients-table').css("opacity", "0.5");
        }).ajaxStop(function() {
            $('#recipients-table').css("opacity", "1");
        });
    });
</script>
